...
update_virtual_y_offset = function() {
	if (state == PLAYER_STATES.CLIMB && instance_exists(climbed_inst)) {
		...
		var _left_ground = get_object(false, false), _right_object = get_object(false, false, GRID_SIZE), _ground_objects = [_left_ground, _right_object], _min_corner_offset = 9999;
