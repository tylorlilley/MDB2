...
if (x > 0 && y > 0 && x < room_width && y < room_height) {
	...
	create_particles(8 + irandom(8), darken_palette(main_palette));
	var _player_particle = create_particles(1, main_palette, death_sprite, false)[0];
	_player_particle.main_palette = main_palette;
