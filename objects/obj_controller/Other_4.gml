...
connect_static_areas_to_manager([obj_metal, obj_tile, obj_brick, obj_rock, obj_sand, obj_bridge, obj_wood], STATIC_AREA_DEPTH, true);
connect_static_areas_to_manager([obj_cloud], STATIC_AREA_DEPTH - 7, true);
connect_static_areas_to_manager([obj_reforming_cloud], STATIC_AREA_DEPTH - 8, true);
connect_static_areas_to_manager([obj_tough_cloud], STATIC_AREA_DEPTH - 9, true);
connect_static_areas_to_manager([obj_leaf], STATIC_AREA_DEPTH - 10, true);
...
with (obj_player) {
	...
	if (is_a(obj_robot)) { is_classic_robot = other.classic_level; }
